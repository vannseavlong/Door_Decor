...
export const mockProducts: Product[] = [
  {
    ...
    description:
      "Modern WPC door with sky blue design, perfect for contemporary homes. Features waterproof and termite-resistant properties.",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Elegant black WPC door with premium finish. Ideal for modern interiors and offices.",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Specialized WPC door with antibacterial coating, perfect for hospitals and clinics.",
    imageUrl:
      "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80",
    images: [
      "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80",
  ...
  },
  {
    ...
    description:
      "Luxurious WPC door with natural wood texture finish, combining beauty and durability.",
    imageUrl:
      "https://images.unsplash.com/photo-1533090161767-e6ffed986c88?w=600&q=80",
    images: [
      "https://images.unsplash.com/photo-1533090161767-e6ffed986c88?w=600&q=80",
  ...
  },
  {
    ...
    description:
      "Clean and modern white WPC door, perfect for minimalist interior design.",
    imageUrl:
      "https://images.unsplash.com/photo-1540979388789-6cee28a1cdc9?w=600&q=80",
    images: [
      "https://images.unsplash.com/photo-1540979388789-6cee28a1cdc9?w=600&q=80",
  ...
  },
  {
    ...
    description:
      "Another variant of our popular sky blue edition with enhanced features.",
    imageUrl:
      "https://images.unsplash.com/photo-1545259741-2ea3ebf61fa3?w=600&q=80",
    images: [
      "https://images.unsplash.com/photo-1545259741-2ea3ebf61fa3?w=600&q=80",
  ...
  },
  {
    ...
    description:
      "Professional-grade black WPC door for commercial and residential use.",
    imageUrl:
      "https://images.unsplash.com/photo-1551122089-4e3e72477b48?w=600&q=80",
    images: [
      "https://images.unsplash.com/photo-1551122089-4e3e72477b48?w=600&q=80",
  ...
  },
  {
    ...
    description:
      "Advanced health edition with superior antibacterial properties.",
    imageUrl:
      "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80",
    images: [
      "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80",
